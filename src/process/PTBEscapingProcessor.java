  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (filename.startsWith("http://")) {
        Document<String, Word, Word> dpre = new BasicDocument<String>((TokenizerFactory<Word>) WhitespaceTokenizer.factory()).init(new URL(filename));
        DocumentProcessor<Word, Word, String, Word> notags = new StripTagsProcessor<String, Word>();
        d = notags.processDocument(dpre);
      } else {
        d = new BasicDocument<String>((TokenizerFactory<Word>) WhitespaceTokenizer.factory()).init(new File(filename));
      }
